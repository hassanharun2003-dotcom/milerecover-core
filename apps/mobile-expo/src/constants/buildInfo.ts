...
export const APP_BUILD_LABEL = '0.2.6-foundation.2';
...
/** App store / runtime version — foundation reset (isolated from 0.2.5 OTA). */
 ...
 */
export const APP_RUNTIME_VERSION = '0.2.6';

/** Preview EAS channel for this foundation APK only. */
export const APP_UPDATE_CHANNEL = 'preview-foundation-0.2.6';
