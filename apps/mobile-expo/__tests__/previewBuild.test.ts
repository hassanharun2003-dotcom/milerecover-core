...
describe('Production MVP build configuration', () => {
  ...
  it('ships package com.milerecover.app and version/runtime 0.1.8', () => {
    expect(APP_PACKAGE_ID).toBe('com.milerecover.app');
    expect(APP_VERSION).toBe('0.1.8');
    expect(APP_BUILD_LABEL).toBe('0.1.8-product-lock.1');
    ...
    expect(appConfigSource).toContain("version: '0.1.8'");
