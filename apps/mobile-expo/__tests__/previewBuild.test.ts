...
describe('Production MVP build configuration', () => {
  ...
  it('ships package com.milerecover.app and version/runtime 0.2.2', () => {
    expect(APP_PACKAGE_ID).toBe('com.milerecover.app');
    expect(APP_VERSION).toBe('0.2.2');
    expect(APP_BUILD_LABEL).toBe('0.2.2-blueprint-lock.2');
    ...
    expect(appConfigSource).toContain("version: '0.2.2'");
